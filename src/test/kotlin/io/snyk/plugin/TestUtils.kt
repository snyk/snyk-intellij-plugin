...
/**
 * Default timeout for panel initialization in milliseconds. This is used by waitForPanelInit to
 * wait for async panel initialization.
 */
const val DEFAULT_PANEL_INIT_TIMEOUT_MS = 5000L

/**
 * Waits for a SuggestionDescriptionPanel to complete its async initialization. This utility is
 * shared across tests to provide consistent timeout handling.
 *
 ...
 */
fun waitForPanelInit(
  panel: SuggestionDescriptionPanel,
  timeoutMs: Long = DEFAULT_PANEL_INIT_TIMEOUT_MS,
) {
