...
class AnnotatorCommonIntegTest : BasePlatformTestCase()  {
    ...
    override fun setUp() {
        ...
        justRun { languageServerWrapperMock.dispose() } // Prevent real dispose logic during project teardown
        justRun { languageServerWrapperMock.shutdown() } // Prevent real shutdown logic if called directly or by dispose, or by resetSettings
        // Add any other LSW methods called by resetSettings if needed, though relaxed=true might cover them
