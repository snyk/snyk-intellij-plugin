...
public class Itly {
    ...
    public void load(
        ...
        schemas.put("Health Score Is Clicked", "{\"$id\":\"https://iterative.ly/company/6d7c255e-5bf5-46fc-be87-58b75c7e0ad5/event/Health%20Score%20Is%20Clicked/version/3.0.0\",\"$schema\":\"http://json-schema.org/draft-07/schema#\",\"title\":\"Health Score Is Clicked\",\"description\":\"Triggered when the user clicks the health score of a package.\",\"type\":\"object\",\"properties\":{\"ide\":{\"description\":\"Ide family.\",\"enum\":[\"Visual Studio Code\",\"Visual Studio\",\"Eclipse\",\"JetBrains\"]},\"ecosystem\":{\"description\":\"What ecosystem for advisor score was used:\\\\n\\\\n* docker\\\\n\\\\n* npm\\\\n\\\\n* python\",\"enum\":[\"npm\",\"python\",\"docker\"]},\"itly\":{\"description\":\"Set to true for filtering within Segment\",\"const\":true},\"packageName\":{\"description\":\"Name of the package for which we get a score.\",\"type\":\"string\"}},\"additionalProperties\":false,\"required\":[\"ide\",\"ecosystem\",\"itly\",\"packageName\"]}");
        ...
        List<Plugin> plugins = new ArrayList<>(Arrays.<Plugin>asList(
            ...
            new IterativelyPlugin(
                ...
                destinations.iteratively.getPluginOptions(
                    "https://api.iterative.ly/t/version/31de5d6b-01a0-469a-ac54-7a4ec688ba17"
                )
            )
        ));
