...
public class Itly {
    ...
    public void load(
      ...
      schemas.put("context", "{\"$id\":\"https://data.amplitude.com/6d7c255e-5bf5-46fc-be87-58b75c7e0ad5/context\",\"$schema\":\"http://json-schema.org/draft-07/schema#\",\"title\":\"Context\",\"description\":\"\",\"type\":\"object\",\"properties\":{},\"additionalProperties\":false,\"required\":[]}");
      ...
      schemas.put("identify", "{\"$id\":\"https://data.amplitude.com/6d7c255e-5bf5-46fc-be87-58b75c7e0ad5/identify\",\"$schema\":\"http://json-schema.org/draft-07/schema#\",\"title\":\"Identify\",\"description\":\"\",\"type\":\"object\",\"properties\":{\"accountType\":{\"description\":\"when a User record is an actual user or when it’s a “service account”\",\"enum\":[\"user\",\"service\",\"app-instance\",\"automated-test-user\"]},\"admin_link\":{\"description\":\"Link to access more information about the user\",\"type\":\"string\"},\"adminLink\":{\"description\":\"Link to access more information about the user\",\"type\":\"string\"},\"auth_provider\":{\"description\":\"Auth provider (login method)\",\"type\":\"string\"},\"authProvider\":{\"description\":\"Auth provider (login method)\",\"type\":\"string\"},\"createdAt\":{\"description\":\"Timestamp of user creation\",\"type\":\"number\"},\"created_at\":{\"description\":\"Timestamp of user creation\",\"type\":\"number\"},\"email\":{\"description\":\"Email address for the user\",\"type\":\"string\"},\"hasFirstIntegration\":{\"description\":\"Whether or not the user has their first integration set up\",\"type\":\"boolean\"},\"hasFirstProject\":{\"description\":\"Whether or not the user has their first project imported\",\"type\":\"boolean\"},\"hasPersonalEmail\":{\"description\":\"Indicates whether user has a personal or business email address\",\"type\":\"boolean\"},\"isNonUser\":{\"description\":\"Applies to non-user identities, such as Snyk Orgs\",\"type\":\"boolean\"},\"is_snyk\":{\"description\":\"Whether or not the user belongs to the Snyk org (determined by the email address ending with @snyk.io)\",\"type\":\"boolean\"},\"isSnyk\":{\"description\":\"Whether or not the user belongs to the Snyk org (determined by the email address ending with @snyk.io)\",\"type\":\"boolean\"},\"isSnykAdmin\":{\"description\":\"Whether or not the user should be considered a Snyk administrator\",\"type\":\"boolean\"},\"productUpdatesConsent\":{\"description\":\"Used by Marketo to determine whether to send product updates emails to users. We are setting this value during product updates consent flow after registration.\",\"type\":\"boolean\"},\"productUpdatesConsentIsDisplayed\":{\"description\":\"A trait for users who got redirected to `/product-updates` consent page.\\\\n\\\\n\\\\nWill allow us to differentiate these users in Marketo and ensure they don't receive product updates emails without explicitly opting in.\",\"type\":\"boolean\"},\"user_id\":{\"description\":\"Public ID of user\",\"type\":\"string\"},\"username\":{\"description\":\"Username of the user\",\"type\":\"string\"},\"utm_campaign\":{\"description\":\"query utm_campaign\",\"type\":\"string\"},\"utmCampaign\":{\"description\":\"query utm_campaign\",\"type\":\"string\"},\"utm_medium\":{\"description\":\"query utm_medium\",\"type\":\"string\"},\"utmMedium\":{\"description\":\"query utm_medium\",\"type\":\"string\"},\"utmSource\":{\"description\":\"query utm_source\",\"type\":\"string\"},\"utm_source\":{\"description\":\"query utm_source\",\"type\":\"string\"}},\"additionalProperties\":false,\"required\":[]}");
      schemas.put("page", "{\"$id\":\"https://data.amplitude.com/6d7c255e-5bf5-46fc-be87-58b75c7e0ad5/page\",\"$schema\":\"http://json-schema.org/draft-07/schema#\",\"title\":\"Page\",\"description\":\"\",\"type\":\"object\",\"properties\":{\"ecosystem\":{\"description\":\"Name of the ecosystem (npm|python|docker...)\",\"type\":\"string\"},\"package\":{\"description\":\"The name of the package\",\"type\":\"string\"},\"path\":{\"description\":\"The canonical path of the page\",\"type\":\"string\"},\"referrer\":{\"description\":\"The page that linked to this page.\",\"type\":\"string\"},\"search\":{\"description\":\"Query parameters in url.\",\"type\":\"string\"},\"title\":{\"description\":\"The page title.\",\"type\":\"string\"},\"url\":{\"description\":\"The url of the page.\",\"type\":\"string\"},\"vulnerabilityId\":{\"description\":\"Used for page views on individual vulnerability pages\",\"type\":\"string\"}},\"additionalProperties\":false,\"required\":[]}");
      schemas.put("Analysis Is Ready", "{\"$id\":\"https://data.amplitude.com/6d7c255e-5bf5-46fc-be87-58b75c7e0ad5/event/Analysis%20Is%20Ready/version/2.0.2\",\"$schema\":\"http://json-schema.org/draft-07/schema#\",\"title\":\"Analysis Is Ready\",\"description\":\"Triggered when the analysis is loaded within the IDE.\",\"type\":\"object\",\"properties\":{\"analysisType\":{\"description\":\"Analysis types selected by the user for the scan:\\\\n\\\\n* open source vulnerabilities\\\\n\\\\n* code quality issues\\\\n\\\\n* code security vulnerabilities\\\\n\\\\n* advisor issues\\\\n\\\\n* infrastructure as code issues\\\\n\\\\n* container vulnerabilities\",\"enum\":[\"Snyk Advisor\",\"Snyk Code Quality\",\"Snyk Code Security\",\"Snyk Open Source\",\"Snyk Container\",\"Snyk Infrastructure as Code\"]},\"ide\":{\"description\":\"Ide family.\",\"enum\":[\"Visual Studio Code\",\"Visual Studio\",\"Eclipse\",\"JetBrains\"]},\"itly\":{\"description\":\"Set to true for filtering within Segment\",\"const\":true},\"result\":{\"description\":\"\",\"enum\":[\"Success\",\"Error\"]}},\"additionalProperties\":false,\"required\":[\"analysisType\",\"ide\",\"itly\",\"result\"]}");
      schemas.put("Analysis Is Triggered", "{\"$id\":\"https://data.amplitude.com/6d7c255e-5bf5-46fc-be87-58b75c7e0ad5/event/Analysis%20Is%20Triggered/version/2.0.2\",\"$schema\":\"http://json-schema.org/draft-07/schema#\",\"title\":\"Analysis Is Triggered\",\"description\":\"User triggers an analysis or analysis is automatically triggered.\",\"type\":\"object\",\"properties\":{\"analysisType\":{\"description\":\"Analysis types selected by the user for the scan: open source vulnerabilities, code quality issues and/or code security vulnerabilities.\",\"type\":\"array\",\"items\":{\"type\":\"string\"},\"minItems\":1,\"uniqueItems\":true},\"ide\":{\"description\":\"Ide family.\",\"enum\":[\"Visual Studio Code\",\"Visual Studio\",\"Eclipse\",\"JetBrains\"]},\"itly\":{\"description\":\"Set to true for filtering within Segment\",\"const\":true},\"triggeredByUser\":{\"description\":\"* True means that the analysis was triggered by the User.\\\\n\\\\n* False means that the analysis was triggered automatically by the plugin.\",\"type\":\"boolean\"}},\"additionalProperties\":false,\"required\":[\"analysisType\",\"ide\",\"itly\",\"triggeredByUser\"]}");
      schemas.put("Authenticate Button Is Clicked", "{\"$id\":\"https://data.amplitude.com/6d7c255e-5bf5-46fc-be87-58b75c7e0ad5/event/Authenticate%20Button%20Is%20Clicked/version/1.0.2\",\"$schema\":\"http://json-schema.org/draft-07/schema#\",\"title\":\"Authenticate Button Is Clicked\",\"description\":\"This Event fires when the authenticate button is clicked.\",\"type\":\"object\",\"properties\":{\"eventSource\":{\"description\":\"Used to identify the source for multi-source events.\\\\n\\\\nFor example, if a given event is shared between Snyk Advisor and Snyk Learn, this property helps to differentiate between the two.\",\"enum\":[\"Advisor\",\"App\",\"Learn\",\"IDE\"]},\"ide\":{\"description\":\"Ide family.\",\"enum\":[\"Visual Studio Code\",\"Visual Studio\",\"Eclipse\",\"JetBrains\"]},\"itly\":{\"description\":\"Set to true for filtering within Segment\",\"const\":true}},\"additionalProperties\":false,\"required\":[\"ide\",\"itly\"]}");
      schemas.put("Health Score Is Clicked", "{\"$id\":\"https://data.amplitude.com/6d7c255e-5bf5-46fc-be87-58b75c7e0ad5/event/Health%20Score%20Is%20Clicked/version/6.0.2\",\"$schema\":\"http://json-schema.org/draft-07/schema#\",\"title\":\"Health Score Is Clicked\",\"description\":\"Triggered when the user clicks the health score of a package.\",\"type\":\"object\",\"properties\":{\"ecosystem\":{\"description\":\"Advisor: what ecosystem for advisor score was used:\\\\n\\\\n* docker\\\\n\\\\n* npm\\\\n\\\\n* python\\\\n\\\\nLearn: the most general grouping for topics/lessons:\\\\n\\\\n* java\\\\n\\\\n* javascript\\\\n\\\\n* kubernetes\\\\n\\\\n* cpp\\\\n\\\\n* csharp\\\\n\\\\n* go\\\\n\\\\n* php\",\"enum\":[\"all\",\"cpp\",\"csharp\",\"docker\",\"java\",\"javascript\",\"kubernetes\",\"npm\",\"php\",\"python\",\"golang\"]},\"ide\":{\"description\":\"Ide family.\",\"enum\":[\"Visual Studio Code\",\"Visual Studio\",\"Eclipse\",\"JetBrains\"]},\"itly\":{\"description\":\"Set to true for filtering within Segment\",\"const\":true},\"packageName\":{\"description\":\"Name of the package for which we get a score.\",\"type\":\"string\"}},\"additionalProperties\":false,\"required\":[\"ecosystem\",\"ide\",\"itly\",\"packageName\"]}");
      schemas.put("Issue In Tree Is Clicked", "{\"$id\":\"https://data.amplitude.com/6d7c255e-5bf5-46fc-be87-58b75c7e0ad5/event/Issue%20In%20Tree%20Is%20Clicked/version/2.0.3\",\"$schema\":\"http://json-schema.org/draft-07/schema#\",\"title\":\"Issue In Tree Is Clicked\",\"description\":\"Triggered when the user selects an issue from the issues list and the issue is loaded.\",\"type\":\"object\",\"properties\":{\"ide\":{\"description\":\"Ide family.\",\"enum\":[\"Visual Studio Code\",\"Visual Studio\",\"Eclipse\",\"JetBrains\"]},\"issueId\":{\"description\":\"Issue ID as received from the backend.\",\"type\":\"string\"},\"issueType\":{\"description\":\"Issue type\",\"enum\":[\"Advisor\",\"Code Quality Issue\",\"Code Security Vulnerability\",\"Licence Issue\",\"Open Source Vulnerability\",\"Infrastructure as Code Issue\",\"Container Vulnerability\"]},\"itly\":{\"description\":\"Set to true for filtering within Segment\",\"const\":true},\"severity\":{\"description\":\"Severity of the issue\",\"enum\":[\"High\",\"Medium\",\"Low\",\"Critical\"]}},\"additionalProperties\":false,\"required\":[\"ide\",\"issueType\",\"itly\"]}");
      schemas.put("Plugin Is Installed", "{\"$id\":\"https://data.amplitude.com/6d7c255e-5bf5-46fc-be87-58b75c7e0ad5/event/Plugin%20Is%20Installed/version/1.0.2\",\"$schema\":\"http://json-schema.org/draft-07/schema#\",\"title\":\"Plugin Is Installed\",\"description\":\"Triggered when the user installs the plugin.\",\"type\":\"object\",\"properties\":{\"ide\":{\"description\":\"Ide family.\",\"enum\":[\"Visual Studio Code\",\"Visual Studio\",\"Eclipse\",\"JetBrains\"]},\"itly\":{\"description\":\"Set to true for filtering within Segment\",\"const\":true}},\"additionalProperties\":false,\"required\":[\"ide\",\"itly\"]}");
      schemas.put("Plugin Is Uninstalled", "{\"$id\":\"https://data.amplitude.com/6d7c255e-5bf5-46fc-be87-58b75c7e0ad5/event/Plugin%20Is%20Uninstalled/version/1.0.2\",\"$schema\":\"http://json-schema.org/draft-07/schema#\",\"title\":\"Plugin Is Uninstalled\",\"description\":\"Triggered when the user uninstalls the plugin.\",\"type\":\"object\",\"properties\":{\"ide\":{\"description\":\"Ide family.\",\"enum\":[\"Visual Studio Code\",\"Visual Studio\",\"Eclipse\",\"JetBrains\"]},\"itly\":{\"description\":\"Set to true for filtering within Segment\",\"const\":true}},\"additionalProperties\":false,\"required\":[\"ide\",\"itly\"]}");
      schemas.put("Product Selection Is Viewed", "{\"$id\":\"https://data.amplitude.com/6d7c255e-5bf5-46fc-be87-58b75c7e0ad5/event/Product%20Selection%20Is%20Viewed/version/1.0.2\",\"$schema\":\"http://json-schema.org/draft-07/schema#\",\"title\":\"Product Selection Is Viewed\",\"description\":\"User has connected the IDE with Snyk and needs to decide which products to enable.\",\"type\":\"object\",\"properties\":{\"ide\":{\"description\":\"Ide family.\",\"enum\":[\"Visual Studio Code\",\"Visual Studio\",\"Eclipse\",\"JetBrains\"]},\"itly\":{\"description\":\"Set to true for filtering within Segment\",\"const\":true}},\"additionalProperties\":false,\"required\":[\"ide\",\"itly\"]}");
      schemas.put("Quick Fix Is Displayed", "{\"$id\":\"https://data.amplitude.com/6d7c255e-5bf5-46fc-be87-58b75c7e0ad5/event/Quick%20Fix%20Is%20Displayed/version/1.0.2\",\"$schema\":\"http://json-schema.org/draft-07/schema#\",\"title\":\"Quick Fix Is Displayed\",\"description\":\"Triggered when quick fix options are displayed to the user in IDE.\",\"type\":\"object\",\"properties\":{\"ide\":{\"description\":\"Ide family.\",\"enum\":[\"Visual Studio Code\",\"Visual Studio\",\"Eclipse\",\"JetBrains\"]},\"itly\":{\"description\":\"Set to true for filtering within Segment\",\"const\":true},\"quickFixType\":{\"description\":\"Quick fix types displayed to the user:\\\\n\\\\n* Show this suggestion\\\\n\\\\n* Ignore this particular suggestion\\\\n\\\\n* Ignore this suggestion in current file\\\\n\\\\nDue to array type definition limitation in Iteratively, the type is enforced in the code as follows:\\\\n\\\\n```\\\\ntype SupportedQuickFixProperties =\\\\n| 'Show Suggestion'\\\\n| 'Ignore Suggestion In Line'\\\\n| 'Ignore Suggestion In File';\\\\n```\",\"type\":\"array\",\"items\":{\"type\":\"string\"},\"minItems\":1,\"uniqueItems\":true}},\"additionalProperties\":false,\"required\":[\"ide\",\"itly\",\"quickFixType\"]}");
      schemas.put("Quick Fix Is Triggered", "{\"$id\":\"https://data.amplitude.com/6d7c255e-5bf5-46fc-be87-58b75c7e0ad5/event/Quick%20Fix%20Is%20Triggered/version/1.0.0\",\"$schema\":\"http://json-schema.org/draft-07/schema#\",\"title\":\"Quick Fix Is Triggered\",\"description\":\"Event for tracking users invoking and triggering our proposed quickfixes.\",\"type\":\"object\",\"properties\":{\"ide\":{\"description\":\"Ide family.\",\"enum\":[\"Visual Studio Code\",\"Visual Studio\",\"Eclipse\",\"JetBrains\"]},\"itly\":{\"description\":\"Set to true for filtering within Segment\",\"const\":true},\"product\":{\"description\":\"Which Snyk product this relates to\",\"enum\":[\"Open Source\",\"Container\",\"Infrastructure as Code\",\"Code\"]},\"quickFixType\":{\"description\":\"Quick fix types displayed to the user:\\\\n\\\\n* Show this suggestion\\\\n\\\\n* Ignore this particular suggestion\\\\n\\\\n* Ignore this suggestion in current file\\\\n\\\\nDue to array type definition limitation in Iteratively, the type is enforced in the code as follows:\\\\n\\\\n```\\\\ntype SupportedQuickFixProperties =\\\\n| 'Show Suggestion'\\\\n| 'Ignore Suggestion In Line'\\\\n| 'Ignore Suggestion In File';\\\\n```\",\"type\":\"array\",\"items\":{\"type\":\"string\"},\"minItems\":1,\"uniqueItems\":true}},\"additionalProperties\":false,\"required\":[\"ide\",\"itly\",\"quickFixType\"]}");
      schemas.put("Welcome Is Viewed", "{\"$id\":\"https://data.amplitude.com/6d7c255e-5bf5-46fc-be87-58b75c7e0ad5/event/Welcome%20Is%20Viewed/version/1.0.2\",\"$schema\":\"http://json-schema.org/draft-07/schema#\",\"title\":\"Welcome Is Viewed\",\"description\":\"User installs the IDE plugin and see Snyk's welcome screen.\",\"type\":\"object\",\"properties\":{\"ide\":{\"description\":\"Ide family.\",\"enum\":[\"Visual Studio Code\",\"Visual Studio\",\"Eclipse\",\"JetBrains\"]},\"itly\":{\"description\":\"Set to true for filtering within Segment\",\"const\":true}},\"additionalProperties\":false,\"required\":[\"ide\",\"itly\"]}");
   ...
   * @param event
   */
  public void quickFixIsDisplayed(String userId, QuickFixIsDisplayed event) {
    track(userId, event);
  }

  /**
   * Event for tracking users invoking and triggering our proposed quickfixes.
   * <p>
   * Owner: Bastian Doetsch
   *
   * @param userId The user's ID.
   * @param event
   */
  public void quickFixIsTriggered(String userId, QuickFixIsTriggered event) {
    track(userId, event);
  }
