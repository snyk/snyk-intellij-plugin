...
public class Itly {
    ...
    public void load(
        ...
        schemas.put("Health Score Is Clicked", "{\"$id\":\"https://iterative.ly/company/6d7c255e-5bf5-46fc-be87-58b75c7e0ad5/event/Health%20Score%20Is%20Clicked/version/1.0.0\",\"$schema\":\"http://json-schema.org/draft-07/schema#\",\"title\":\"Health Score Is Clicked\",\"description\":\"Triggered when the user clicks the health score of a package.\",\"type\":\"object\",\"properties\":{\"ide\":{\"description\":\"Ide family.\",\"enum\":[\"Visual Studio Code\",\"Visual Studio\",\"Eclipse\",\"JetBrains\"]},\"itly\":{\"description\":\"Set to true for filtering within Segment\",\"const\":true}},\"additionalProperties\":false,\"required\":[\"ide\",\"itly\"]}");
        ...
        List<Plugin> plugins = new ArrayList<>(Arrays.<Plugin>asList(
            ...
            new IterativelyPlugin(
                ...
                destinations.iteratively.getPluginOptions(
                    "https://api.iterative.ly/t/version/f254a640-bfd9-4421-bb75-e6cd8f21f6a6"
                )
            )
        ));
