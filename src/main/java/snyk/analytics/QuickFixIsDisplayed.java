...
public class QuickFixIsDisplayed extends Event {
  private static final String NAME = "Quick Fix Is Displayed";
  private static final String ID = "170c1284-9ee6-457f-aa82-6c49e49cde93";
  ...
  private QuickFixIsDisplayed(Builder builder) {
    super(NAME, builder.properties, ID, VERSION);
  }

  private QuickFixIsDisplayed(QuickFixIsDisplayed clone) {
    super(NAME, new HashMap<>(clone.getProperties()), ID, VERSION);
  }

  public QuickFixIsDisplayed clone() {
    return new QuickFixIsDisplayed(this);
  }
  ...
  public static class Builder implements IIde, IQuickFixType, IBuild {
    ...
    public QuickFixIsDisplayed build() {
      return new QuickFixIsDisplayed(this);
    }
  }
