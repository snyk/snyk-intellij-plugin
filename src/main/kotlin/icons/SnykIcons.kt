...
object SnykIcons {
  private fun getIconFromResources(name: String): ImageIcon =
    ImageIcon(this::class.java.getResource(name))

  @JvmField val TOOL_WINDOW = getIcon("/icons/snyk-dog.svg", SnykIcons::class.java)
  ...
  // copy of FeaturesTrainerIcons.Img.GreenCheckmark from
  // https://jetbrains.github.io/ui/resources/icons_list/
  val CHECKMARK_GREEN = getIcon("/icons/greenCheckmark.svg", SnykIcons::class.java)

  private val CRITICAL_SEVERITY_16 =
    getIcon("/icons/severity_critical_16.svg", SnykIcons::class.java)
  private val CRITICAL_SEVERITY_32 =
    getIcon("/icons/severity_critical_32.svg", SnykIcons::class.java)
