...
/**
 * Listens for application activation events (IDE window gaining focus) and refreshes the Snyk tool
 * window UI to ensure any updates that occurred while the window was not visible are properly
 * displayed.
 */
