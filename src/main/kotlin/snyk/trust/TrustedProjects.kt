...
/**
 * Shows the "Trust and Scan Project?" dialog, if the user wasn't asked yet if they trust this
 * project, and sets the project trusted state according to the user choice.
 *
