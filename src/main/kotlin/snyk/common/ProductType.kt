...
enum class ProductType(
  ...
  CODE_SECURITY(
    ...
    description =
      "Find and fix vulnerabilities in your application code in real time. For these scans to run, Snyk Code must be enabled for your organization in Snyk settings.",
  ) {
    override fun getCountText(count: Int, isUniqueCount: Boolean): String =
      getVulnerabilitiesCountText(count, isUniqueCount)
  };
