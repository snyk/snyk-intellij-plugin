...
object SnykAnnotationAttributeKey {
  val unknown: TextAttributesKey =
    TextAttributesKey.createTextAttributesKey(
      "Unknown Severity",
      TextAttributesKey.find("INFO_ATTRIBUTES"),
    )
  val low: TextAttributesKey =
    TextAttributesKey.createTextAttributesKey(
      "Low Severity",
      TextAttributesKey.find("INFO_ATTRIBUTES"),
    )
  val medium: TextAttributesKey =
    TextAttributesKey.createTextAttributesKey(
      "Medium Severity",
      TextAttributesKey.find("WARNING_ATTRIBUTES"),
    )
  val high: TextAttributesKey =
    TextAttributesKey.createTextAttributesKey(
      "High Severity",
      TextAttributesKey.find("ERRORS_ATTRIBUTES"),
    )
  val critical: TextAttributesKey =
    TextAttributesKey.createTextAttributesKey(
      "Critical Severity",
      TextAttributesKey.find("ERRORS_ATTRIBUTES"),
    )
