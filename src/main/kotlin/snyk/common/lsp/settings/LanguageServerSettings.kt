...
data class LanguageServerSettings(
  ...
  val authenticationMethod: String = AuthenticationType.OAUTH2.languageServerSettingsName,
  ...
  @SerializedName("enableSnykOSSQuickFixCodeActions")
  val enableSnykOSSQuickFixCodeActions: String? = null,
  @SerializedName("requiredProtocolVersion")
  val requiredProtocolVersion: String = pluginSettings().requiredLsProtocolVersion.toString(),
