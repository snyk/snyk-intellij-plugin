...
- after changing .go files, check for linting errors. only continue, once they are fixed. The only acceptable outcome is 0 linting errors.
- always verify if fixes worked by running the tests and linting
...
- create high definition png files from mermaid syntax and add them to the documentation in ./docs using kroti web api using default colours
